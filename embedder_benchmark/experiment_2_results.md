...
**Script**: `experiments/experiment_2_embedding_benchmark.py` + `experiments/embedding_benchmark_gpu.ipynb`
...
Per-model artifacts (`experiments/experiment_2_{MODEL}_*.png`):
