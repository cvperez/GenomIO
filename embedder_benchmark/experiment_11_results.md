...
**Script**: `experiments/experiment_11_text_encoder_benchmark.py`
...
|---|---|---|---|---|---|
| MiniLM-L6-v2 (baseline) | sentence-transformers/all-MiniLM-L6-v2 | 384 | mean | — | current Index B |
| bge-small-en-v1.5 | BAAI/bge-small-en-v1.5 | 384 | ST default | — | same-size drop-in |
| bge-large-en-v1.5 | BAAI/bge-large-en-v1.5 | 1024 | ST default | — | larger general (MIT) |
| SapBERT | cambridgeltl/SapBERT-from-PubMedBERT-fulltext | 768 | **CLS** | — | biomedical entity-name specialist |
| MedEmbed-base | abhinand/MedEmbed-base-v0.1 | 768 | ST default | — | biomedical retrieval (BGE fine-tuned) |
...
### Reproduce
```bash
python experiments/experiment_11_text_encoder_benchmark.py
```
